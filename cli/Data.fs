...
let day2 = readFile "datafileDay2.txt"

let day3 = readFile "datafileDay3.txt"

let day4 : string list list = readFile "datafileDay4.txt" |> split [] []

let day5 = readFile "datafileDay5.txt"
