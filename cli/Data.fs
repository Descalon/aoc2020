...
let day2 = Seq.toList <| seq {
    use sr = new StreamReader("datafileDay2.txt")
    while not sr.EndOfStream do
        yield sr.ReadLine()
}

let day3 = Seq.toList <| seq {
    use sr = new StreamReader("datafileDay3.txt")
    while not sr.EndOfStream do
        yield sr.ReadLine()
}

let day4 : string list list = 
    let s = seq {
